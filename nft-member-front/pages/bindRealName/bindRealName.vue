	...
	<view>
		<view class="info-form">
			<u-form class="transfer-form" :border-bottom="false">
				...
				<u-form-item label-position="left" label="联系方式" label-width="150" :border-bottom="false">
					<u-input v-model="mobile" type="text" :clearable="false" :disabled="true">
					</u-input>
				</u-form-item>
			</u-form>
		</view>
		<view class="info-tips">
			<view class="info-tip info-tip1">
				根据法律法规要求，实名信息须与注册手机号持有人相符，且年满21周岁并小于60周岁。
			</view>
			<view class="info-tip">
