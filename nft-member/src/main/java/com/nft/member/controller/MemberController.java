...
public class MemberController {
	...
	@OperLog(subSystem = Constant.子系统_会员端, module = 模块_会员账号, operate = "修改昵称")
	...
	@OperLog(subSystem = Constant.子系统_会员端, module = 模块_会员账号, operate = "修改头像")
	...
	@OperLog(subSystem = Constant.子系统_会员端, module = 模块_会员账号, operate = "实名认证")
