...
import com.nft.collection.service.IssuedCollectionService;
...
public class MemberHoldCollectionController {
	...
	@OperLog(subSystem = Constant.子系统_后台管理, module = 模块_持有艺术品, operate = "手动销毁")
	@GetMapping("/manualDestroy")
	@ResponseBody
	public Result<String> manualDestroy(String id) {
		issuedCollectionService.manualDestroy(id);
