...
public class ComposeActivityController {
	...
	@OperLog(subSystem = Constant.子系统_后台管理, module = 模块_合成活动, operate = "调整活动时间")
	@PostMapping("/adjustComposeActivityTime")
	@ResponseBody
	public Result<String> adjustComposeActivityTime(AdjustComposeActivityTimeParam param) {
		composeActivityService.adjustComposeActivityTime(param);
		return Result.success();
	}
