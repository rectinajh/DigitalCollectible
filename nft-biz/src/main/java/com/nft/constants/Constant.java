...
public class Constant {
	...
	public static final String 轮播点击处理方式_纯展示 = "1";

	public static final String 轮播点击处理方式_内部链接 = "2";

	public static final String 轮播点击处理方式_跳转外链 = "3";

	public static final String 风控处罚_限制下单 = "limitPlaceOrder";

	public static final String 风控原因_下单未付款 = "riskOrderUnpaid";

	public static final String IP黑名单 = "ipBlackList";

	public static final String 空投业务类型_新手奖励 = "1";

	public static final String 空投业务类型_首单奖励 = "2";

	public static final String 空投业务类型_邀请奖励 = "3";

	public static final String 空投业务类型_空投任务 = "4";

	public static final String 空投业务类型_手动空投 = "5";

	public static final String 空投记录状态_未执行 = "1";

	public static final String 空投记录状态_已执行 = "2";

	public static final String 空投记录状态_库存不足 = "3";

	public static final String 空投记录状态_已取消 = "4";

	public static final String 空投发放 = "airDropGrant";

	public static final String 执行空投任务 = "executeAirDropTask";

	public static final String 空投任务状态_未执行 = "1";

	public static final String 空投任务状态_已执行 = "2";

	public static final String 空投任务状态_已取消 = "3";

	public static final String 快照参数_最近支付时间 = "latelyPaidTime";

	public static final String 快照参数_首次支付时间 = "firstPaidTime";

	public static final String 快照参数_支付次数 = "paidCount";

	public static final String 快照参数_支付金额 = "paidAmount";

	public static final String 快照参数_注册时间 = "registeredTime";

	public static final String 快照参数_全部有效会员 = "effectiveMember";

	public static final String 快照参数_有效邀请人数 = "effectiveInvitedCount";

	public static final String 快照参数_持有艺术品 = "holdArtwork";

	public static final String 奖励发放状态_未发放 = "1";

	public static final String 奖励发放状态_已发放 = "2";

	public static final String 奖励发放状态_发放失败 = "3";

	public static final String 邀请奖励 = "invitedReward";

	public static final String 邀请奖励发放 = "invitedRewardGrant";

	public static final String 首单奖励 = "firstOrderReward";

	public static final String 首单奖励发放 = "firstOrderRewardGrant";

	public static final String 实名认证奖励 = "realNameReward";

	public static final String 实名认证奖励发放 = "realNameRewardGrant";

	public static final String 区块链类型_不上链 = "noneChain";

	public static final String 区块链类型_文昌链 = "wenChangChain";
	...
	public static final String 兑换码状态_未使用 = "1";

	public static final String 兑换码状态_已使用 = "2";

	public static final String 兑换码状态_已作废 = "3";
	
	public static final String 兑换码状态_已过期 = "4";
	...
	public static final String 持有藏品状态_手动销毁 = "7";
