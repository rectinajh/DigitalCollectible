...
public class InvitedRewardRecordQueryCondParam extends PageParam {

	private String memberMobile;

	private String state;

	public Specification<InvitedRewardRecord> buildSpecification() {
		InvitedRewardRecordQueryCondParam param = this;
		Specification<InvitedRewardRecord> spec = new Specification<InvitedRewardRecord>() {
			/**
			 * 
			 */
			private static final long serialVersionUID = 1L;

			public Predicate toPredicate(Root<InvitedRewardRecord> root, CriteriaQuery<?> query,
