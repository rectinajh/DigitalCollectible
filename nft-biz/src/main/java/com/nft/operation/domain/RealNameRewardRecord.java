...
@Setter
@Entity
@Table(name = "real_name_reward_record")
@DynamicInsert(true)
@DynamicUpdate(true)
public class RealNameRewardRecord implements Serializable {
	...
	public static RealNameRewardRecord build(String memberId, String collectionId) {
		RealNameRewardRecord po = new RealNameRewardRecord();
