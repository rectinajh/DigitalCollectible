...
import com.nft.common.utils.RedisUtils;
...
public class Member implements Serializable {
	...
	private MemberInvitedCount memberInvitedCount;
	...
	public void validPlaceOrderRisk() {
		validBasicRisk();
		if (this.isRiskLimit(Constant.风控处罚_限制下单)) {
			throw new BizException("已暂时被限制下单,请稍后再试");
		}
	}
	...
	public Boolean isRiskLimit(String riskPunish) {
