...
public class WenChangChainUtils {
	...
	public static Map<String, String> buildHeader(String signature, Long timestamp, String apiKey) {
		Map<String, String> headerMap = new HashMap<>();
		headerMap.put("X-Api-Key", apiKey);
		headerMap.put("X-Timestamp", timestamp.toString());
